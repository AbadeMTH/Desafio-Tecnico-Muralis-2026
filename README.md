...
- Mostrar de forma simples e intuitiva esses dados corretamente.
...
2. Clone o repositório através do prompt de comando (CMD ou outros) em uma pasta de sua preferência (ou baixe o arquivo .ZIP):
   ```git
...
6. Salve o arquivo
7. Abra seu Docker
8. Abra o prompt de comando (CMD ou outros) no caminho raiz de onde clonou o projeto, por exemplo: ```C:\Users\muralis\Desafio-Tecnico-Muralis-2026```
9. Execute o comando:
    ```docker
    docker-compose up --build
   ```
10. Aguarde o Docker subir a imagem (o que pode levar algumas tentativas)
...
12. Caso queira finalizar o projeto, no prompt de comando (CMD ou outros) que executou o comando do docker, pressione simultaneamente as teclas:
    ```CTRL + C```
...
Já no front-end, que não é nem um pouco meu forte, o GitHub Copilot foi um grande amigo. Nunca tive muito contato com manipulação de DOM, então ele me guiou em boa parte do desenvolvimento do front, mas sempre que aceitava uma sugestão, eu parava para ler o código, entender e analisar se fazia sentido.
